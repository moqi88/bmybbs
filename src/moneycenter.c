...
marry_query_records(char *id)
{
	...
	move(6, 0);
	sprintf(buf,"\033[1;36m%-6.6s %-20.20s %-10.10s %-10.10s %-16.16s %-4.4s %-6.6s\033[m","±àºÅ","Ö÷Ìâ","ĞÂÄï","ĞÂÀÉ","Çó/½á/»éÀñÊ±¼ä","µ½·Ã","×´Ì¬");
	prints(buf);
	move(7, 0);
	prints("--------------------------------------------------------------------------------------");
	pages = n / 10 + 1;
...
marry_active_records(struct MC_Marry *marryMem, int n)
{
	...
	move(6, 0);
	sprintf(buf,"\033[1;36m%-6.6s %-20.20s %-10.10s %-10.10s %-16.16s %-4.4s %-6.6s\033[m","±àºÅ","Ö÷Ìâ","ĞÂÄï","ĞÂÀÉ","Çó»é/»éÀñÊ±¼ä","µ½·Ã","×´Ì¬");
	prints(buf);
	move(7, 0);
	prints("--------------------------------------------------------------------------------------");
	pages = n / 10 + 1;
...
marry_attend(struct MC_Marry *marryMem, int n)
{
	...
	move(6, 0);
	sprintf(buf,"\033[1;36m%-6.6s %-20.20s %-10.10s %-10.10s %-16.16s %-4.4s %-6.6s\033[m","±àºÅ","Ö÷Ìâ","ĞÂÄï","ĞÂÀÉ","»éÀñÊ±¼ä","µ½·Ã","×´Ì¬");
	prints(buf);
	move(7, 0);
	prints("--------------------------------------------------------------------------------------");
	pages = n / 10 + 1;
